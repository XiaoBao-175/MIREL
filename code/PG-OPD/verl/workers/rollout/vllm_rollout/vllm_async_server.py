...
class vLLMHttpServer:
    ...
    def __init__(
        ...
        # Respect an explicit rollout.max_model_len.  The unconditional
        # assignment here overwrites the launcher value with Qwen's 262144
        # context length, which makes vLLM request an impossible KV cache for
        # the actual 17408-token training budget.
